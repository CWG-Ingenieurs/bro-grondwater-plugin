...
├── bro_grondwater.py             # Main plugin class
├── bro_grondwater_dialog.py      # Dialog wrapper
├── bro_grondwater_dialog_base.ui # Qt Designer UI file
...
### 2. Main Plugin Class (`bro_grondwater.py`)
...
### 3. Dialog Class (`bro_grondwater_dialog.py`)
...
### 4. UI File (`bro_grondwater_dialog_base.ui`)
...
```python
from bro_grondwater import BROGrondwaterPlugin
plugin = iface.plugins['bro_grondwater']
# Test methods
```
