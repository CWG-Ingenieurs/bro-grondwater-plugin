...
packages = ['hydropandas', 'pandas', 'xlsxwriter', 'matplotlib']
...
2. Copy `bro_grondwater` folder to QGIS plugins directory
3. Restart QGIS
...
| Excel export fails | Verify xlsxwriter is installed |
