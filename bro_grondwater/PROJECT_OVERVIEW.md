...
│   ├── bro_grondwater.py             # Main plugin logic
│   ├── bro_grondwater_dialog.py      # Dialog handler
│   └── bro_grondwater_dialog_base.ui # UI definition
│
├── Configuration
...
2. **Install Plugin**
   - Copy `bro_grondwater` folder to QGIS plugins directory
   - Restart QGIS
